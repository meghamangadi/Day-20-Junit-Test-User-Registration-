...
public class ParametrisedEmailValidationTest {
	private String email;
	private boolean expectedResult;

	public ParametrisedEmailValidationTest(String email, boolean expectedResult) {
		this.email = email;
	...
	public void givenEmailIds_withExpectedResult_shouldPassAllTheTestCases() {
		ParametrisedEmailValidation emailValidation = new ParametrisedEmailValidation();
		boolean result = emailValidation.email(this.email);
